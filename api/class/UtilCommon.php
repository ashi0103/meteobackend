...
//        }
    ...
    function secondsToDayMinsHrs($seconds) {
        $date = new DateTime('@' . (int)$seconds);
...
//        }
        ...
        $totaltime = $totalDay . $day . $totalHr . $hr . $totalMin . $min;
        return $totaltime;
    }

    function MinsToDayHrsMin($minutes) {
//        $totalHr = gmdate("H", $minutes);
//        $totalMin = gmdate("i", $minutes);
        $totalDay = gmdate("d", mktime(0, $minutes));
