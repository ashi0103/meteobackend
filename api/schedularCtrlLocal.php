...
//http://localhost:4200/meteo/api/schedularCtrlLocal.php/parseXml
...
// Open a directory, and read its contents
    ...
    $dir = 'C:/Requirements/xmls/';  //$dir.'/OML/';
    echo $dir;
    $destinationFilePath = 'C:/Requirements/xmls/archive/';  //dirname(__DIR__, 3).'/OML/archive/';
    //$destFilePathcopy = $dir.'/Hydras3/';//'C:/Requirements/xmls/Hydras3/';
